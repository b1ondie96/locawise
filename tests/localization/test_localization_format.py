...
from locawise.localization.format import find_extension, LocalizationFormat, detect_format
...
def test_detect_format_properties_file(mocker):
    find_suffix_mock = mocker.patch("locawise.localization.format.find_extension")
