...
from src.threepio.localization_formats import find_suffix, LocalizationFormat, detect_format
...
def test_detect_format_properties_file(mocker):
    find_suffix_mock = mocker.patch("src.threepio.localization_formats.find_suffix")
